...
extension AsrModels {
    ...
    private static func inferredVersion(from directory: URL) -> AsrModelVersion? {
        ...
        if directoryPath.contains(AsrModelVersion.v3.repo.folderName.lowercased()) {
            return .v3
        }
        return nil
    }
...
extension AsrModels {
    ...
    public static func modelsExist(at directory: URL, version: AsrModelVersion) -> Bool {
        ...
        let vocabPath = repoPath.appendingPathComponent(Names.vocabularyFile)
