...
public final class ANEMemoryOptimizer {
    ...
    public func createAlignedArray(
        ...
        do {
            ...
            throw ANEMemoryOptimizerError.memoryAllocationFailed
        } catch {
            throw ANEMemoryOptimizerError.memoryAllocationFailed
        }
    }
    ...
    public func createZeroCopyView(
        ...
        guard offset + viewElements <= sourceElements else {
            throw ANEMemoryOptimizerError.invalidArrayBounds
        }
...
public enum ANEMemoryOptimizerError: Error, LocalizedError {
    ...
    public var errorDescription: String? {
        ...
        case .invalidArrayBounds:
            return "Invalid MLMultiArray view bounds"
        }
    }
}
...
public final class ZeroCopyFeatureProvider: NSObject, MLFeatureProvider {
    ...
    public static func batchProvider(
        ...
        return zip(waveforms, masks).map { waveform, mask in
            ZeroCopyFeatureProvider(features: [
